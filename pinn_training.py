...
def val_split(x_r,t_r,u_b,x_b,t_b,u_i,x_i,t_i,split=0.2):
    ...
    u_b_train,x_b_train,t_b_train = u_b[idx_b[:N_b_train]],x_b[idx_b[:N_b_train]],t_b[idx_b[:N_b_train]]
    u_b_val,x_b_val,t_b_val = u_b[idx_b[N_b_train:]],x_b[idx_b[N_b_train:]],t_b[idx_b[N_b_train:]]
    u_i_train,x_i_train,t_i_train = u_i[idx_i[:N_i_train]],x_i[idx_i[:N_i_train]],t_i[idx_i[:N_i_train]]
    u_i_val,x_i_val,t_i_val = u_i[idx_i[N_i_train:]],x_i[idx_i[N_i_train:]],t_i[idx_i[N_i_train:]]
...
def val_split_with_labels(x_r,t_r,u_b,x_b,t_b,u_i,x_i,t_i,split=0.2):
    ...
    u_i_train,x_i_train,t_i_train = u_i[idx_i[:N_i_train]],x_i[idx_i[:N_i_train]],t_i[idx_i[:N_i_train]]
    u_i_val,x_i_val,t_i_val = u_i[idx_i[N_i_train:]],x_i[idx_i[N_i_train:]],t_i[idx_i[N_i_train:]]
    x_r_train_label,t_r_train_label = sequence_to_label(x_r_train),sequence_to_label(t_r_train)
    x_r_val_label,t_r_val_label = sequence_to_label(x_r_val),sequence_to_label(t_r_val)
    u_b_train_label,x_b_train_label,t_b_train_label = sequence_to_label(u_b_train),sequence_to_label(x_b_train),sequence_to_label(t_b_train)
    u_b_val_label,x_b_val_label,t_b_val_label = sequence_to_label(u_b_val),sequence_to_label(x_b_val),sequence_to_label(t_b_val)
    u_i_train_label,x_i_train_label,t_i_train_label = sequence_to_label(u_i_train),sequence_to_label(x_i_train),sequence_to_label(t_i_train)
    u_i_val_label,x_i_val_label,t_i_val_label = sequence_to_label(u_i_val),sequence_to_label(x_i_val),sequence_to_label(t_i_val)
...
if not with_rnn:
    train_data,val_data = val_split(x_r,t_r,u_b,x_b,t_b,u_i,x_i,t_i,split=0.2)
else:
    train_data,val_data,train_data_labels,val_data_labels = val_split_with_labels(x_r,t_r,u_b,x_b,t_b,u_i,x_i,t_i,split=0.2)
...
def train_rnn(model,train_data,val_data,epochs):
    ...
    for epoch in epochs:
        #Shuffle train_data
        index_shuf = torch.randperm(train_data[0].shape[0])
        train_data_new = [train_data[0][index_shuf],train_data[1][index_shuf],train_data[2][index_shuf],train_data[3][index_shuf],train_data[4][index_shuf],train_data[5][index_shuf],train_data[6][index_shuf],train_data[7][index_shuf],train_data[8][index_shuf],train_data[9][index_shuf],train_data[10][index_shuf],train_data[11][index_shuf],train_data[12][index_shuf],train_data[13][index_shuf],train_data[14][index_shuf],train_data[15][index_shuf]]
        train_data = train_data_new
